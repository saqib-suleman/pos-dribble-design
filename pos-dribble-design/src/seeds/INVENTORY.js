...
export const BRANDS_DATA = [
  { id: uuid(), name: "Nike", articles: NIKE_ARTICLES_DATA.length },
  { id: uuid(), name: "Adidas", articles: ADIDAS_ARTICLES_DATA.length },
  { id: uuid(), name: "Reebok", articles: REEBOK_ARTICLES_DATA.length },
  { id: uuid(), name: "Puma", articles: PUMA_ARTICLES_DATA.length },
  { id: uuid(), name: "Vans", articles: VANS_ARTICLES_DATA.length },
];
